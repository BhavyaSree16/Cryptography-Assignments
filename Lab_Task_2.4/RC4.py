...
def encrypt_text():
    ...
    with open("./Cryptography_assignment-1/Lab_Task_2.4/EncryptedText.txt", "w", encoding="utf-8") as enc_file:
        enc_file.write(cipher_text)
    
    decrypted_text = rc4_encrypt_decrypt(cipher_text, key)
    
    with open("./Cryptography_assignment-1/Lab_Task_2.4/DecryptedText.txt", "w", encoding="utf-8") as dec_file:
...
def encrypt_file():
    ...
    try:
        with open(f'./Cryptography_assignment-1/Lab_Task_2.4/{filename}', "r", encoding="utf-8") as file:
            file_data = file.read()
        ...
        with open("./Cryptography_assignment-1/Lab_Task_2.4/EncryptedFile.txt", "w", encoding="utf-8") as enc_file:
            enc_file.write(encrypted_data)

        decrypted_data = rc4_encrypt_decrypt(encrypted_data, key)

        with open("./Cryptography_assignment-1/Lab_Task_2.4/DecryptedFile.txt", "w", encoding="utf-8") as dec_file:
